        ...
        <div class="col-md-12 text-center">
            ...
            <div class="row justify-content-center  ">
                ...
                <div class="col-md-6 col-lg-4 col-sm-8  rounded border shadow p-3 mb-5 bg-white " id="col-Login" >
                            ...
                            <form  method="POST" action="{{url('registerfromadmins')}}">
                                {{ csrf_field() }}
                               ...
                               <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                    <input type="password" class="form-control @if($errors->get('password')) is-invalid @endif"  id="password" name="password"  placeholder="Password" required>
                                ...
                                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                 ...
                                 <div class="form-group">
                                   <select id="product_categorie" class="form-control" name="genre">
