...
<section class="bg-light" >
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <form method="POST" action="{{url('admincategories')}}" enctype="multipart/form-data">
              {{csrf_field()}}
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="text-center">
                   <input type="submit" class="btn btn-primary btn-block btn-lg" value="Ajouter la catégorie">
                  </div>
             </form>
           </div>
         </div>
