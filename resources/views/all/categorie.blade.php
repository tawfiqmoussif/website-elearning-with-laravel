      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading text-uppercase">{{$categorie->nom}}</h2>
            <img class="img-fluid" src="{{asset('storage/'.$categorie->photo)}}" alt="">
            <br/>
            <h3 class=" text-muted">{{$categorie->small_description}}</h3>
            <h4 class="section-subheading text-muted">{{$categorie->full_description}}</h4>
          </div>
        </div>
<!-----posts--------------->
        <div class="row">
